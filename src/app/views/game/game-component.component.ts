...
export class GameComponent {
  ...
  rellenarArray(){
    ...
    this.verbos[31]= { traduccion:"saber/conocer",            present:"know",       sonidoPresent:"know__gb_1.mp3",       pastSimple:"knew",         sonidoPastSimple:"knew__gb_1.mp3",        pastParticiple:"known", sonidoParticiple:""};
    ...
    this.verbos[58]= { traduccion:"cantar/hablar",            present:"tell",       sonidoPresent:"tell__gb_1.mp3",       pastSimple:"told",         sonidoPastSimple:"told__gb_1.mp3",        pastParticiple:"told", sonidoParticiple:"told__gb_1.mp3"} ;
